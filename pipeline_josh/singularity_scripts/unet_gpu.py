...
def unet_test(img, input_sz=(64,64,64), step=(24,24,24), mask=None):
    ...
    model_file = '/groups/dickson/dicksonlab/lillvis/ExM/Ding-Ackerman/crops-for-training_Oct2018/DING/model_DNN/retrain_2020_unet_model_tests/retrain_2020_unet_model_3/unet_3001.whole.h5'
